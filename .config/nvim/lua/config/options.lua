...
vim.opt.spelllang = { "en" } -- Set language for spellcheck
...
vim.opt.smartcase = true -- Case-sensitive if uppercse in search
...
vim.opt.lazyredraw = false -- Redraw while executing macros (buffer UX)
...
vim.opt.diffopt:append("algorithm:patience") -- Better diff algorithem
...
--  "a:blinkwat700-blinkoff400-blinkon250-Cursor/lCursor", -- All modes: blinking & highlight groups
